...
export function UserDishSearch() {
  const [tab, setTab] = useState<"keyword" | "image">(
    "keyword",
  );
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="flex gap-3">
              ...
              <button className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-medium px-6 py-3 rounded-xl text-sm transition">
